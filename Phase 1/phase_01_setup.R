...
#
# Purpose:
# Install and load all R packages required for the complete
# HBV immune-state scRNA-seq analysis pipeline.
#
...
#
# It only prepares the computational environment.
#
# NOTE:
# renv is intentionally NOT used in this project.
